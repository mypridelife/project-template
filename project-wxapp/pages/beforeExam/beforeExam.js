...
const { examList, answer, upload, submit } = require('../../config')
    ...
    return new Promise((resolve, reject) => {
      ...
      wx.request({
        ...
        data: {
          ...
          // candidateAnswerFile: this.data.candidateAnswerFile,
          // candidateAnswerVideo: this.data.candidateAnswerVideo
        },
        method: 'POST',
        header: {
    ...
    wx.request({
      ...
      success(res) {
        ...
        if (res.data.success) {
          ...
          $Toast({
            content: '成绩未到80%，您未通过考试题，3秒钟之后开始重新回答考试题',
            type: 'loading',
            duration: 3
          })
          setTimeout(() => {
